...
export function ArchiveTimeline({ yearGroups }: ArchiveTimelineProps) {
  ...
  return (
    <div className="mt-8 sm:mt-10">
      <div className="mb-6 flex flex-col gap-3 rounded-[18px] border border-ink-200 bg-white p-4 sm:rounded-md dark:border-ink-800 dark:bg-ink-950 sm:flex-row sm:items-center sm:justify-between">
        <div>
        ...
        <div className="grid grid-cols-2 gap-2 sm:flex sm:flex-wrap">
          <button
            type="button"
            onClick={expandAll}
            className="inline-flex min-h-10 items-center justify-center gap-2 rounded-md border border-ink-200 bg-ink-50 px-3 py-2 text-sm font-medium text-ink-700 transition hover:border-signal-300 hover:text-signal-700 dark:border-ink-800 dark:bg-ink-900 dark:text-ink-200 dark:hover:border-signal-700 dark:hover:text-signal-300"
          >
                            ...
                            <div className="space-y-3">
                              {group.posts.map((post) => (
                                <article key={post.slug} className="group relative pl-10 sm:pl-16">
                                  ...
                                  <div className="rounded-[18px] border border-ink-200 bg-white p-4 transition duration-200 group-hover:-translate-y-0.5 group-hover:border-signal-300 group-hover:bg-ink-50/80 group-hover:shadow-soft sm:rounded-md sm:p-5 dark:border-ink-800 dark:bg-ink-950 dark:group-hover:border-signal-700 dark:group-hover:bg-ink-900/60 dark:group-hover:shadow-soft-dark">
