...
export function HeroSection() {
  return (
    <section className="relative isolate min-h-[calc(100svh-4.25rem)] overflow-hidden border-b border-border bg-bg">
        ...
        <div className="mx-auto grid min-h-[calc(100svh-4.25rem)] max-w-[90rem] grid-cols-1 px-5 sm:px-8 xl:grid-cols-12 xl:px-14">
          <div className="flex flex-col justify-between border-border py-12 sm:py-16 xl:col-span-8 xl:border-r xl:py-20">
            ...
            <div className="max-w-6xl py-14 pr-0 xl:py-16 xl:pr-12" data-reveal>
            ...
            <div className="grid gap-4 border-t border-border pt-5 pr-0 text-sm font-medium leading-6 text-secondary sm:grid-cols-3 xl:pr-12">
              {[
                "无线算法与系统仿真",
                "AI 辅助研发与工具链",
                "技术管理与组织协同"
      ...
      <div className="relative flex items-center py-10 sm:py-14 xl:col-span-4 xl:min-h-0 xl:pl-8 xl:py-20">
        <div className="relative ml-auto w-full max-w-[30rem]" data-reveal>
              <div className="group relative aspect-[4/3] w-full overflow-hidden bg-denim sm:aspect-[3/2] xl:aspect-[4/5]">
                <Image
